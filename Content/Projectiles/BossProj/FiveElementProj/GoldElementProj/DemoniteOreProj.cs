...
{
    public class DemoniteOreProj : ModProjectile
    {
        public override string Texture => "Terraria/Images/Item_" + ItemID.DemoniteOre;
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                Dust.NewDust(Projectile.Center, Projectile.width, Projectile.height, DustID.Demonite);
            }
        }
